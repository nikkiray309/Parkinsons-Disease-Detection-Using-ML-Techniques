    ...
    if request.method == 'POST':
        try:
           ...
           # filename = 'modelforprediction.sav'
            loaded_model = pickle.load(open("C:/Python_Projects/MINI/modelforprediction.sav", 'rb'))  # loading the model file from the storage
            # predictions using the loaded model file
            scaler = pickle.load(open("C:/Python_Projects/MINI/standardScaler.sav", 'rb'))
